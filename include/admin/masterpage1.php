               ...
               <ul class="navbar-nav mr-auto size">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">';
                        ...
                        while($row = $db -> fetch()){
                           $xau .= '<a class="dropdown-item" href="index1.php?id='.$row['category_id'].'">'.$row["category_name"].'</a>';
                        }
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="index1.php">Contact</a>
                  </li>
                  
                  <li class="nav-item" style="margin-left: 3rem;">
                     <a class="nav-link" href="index1.php"><i class="fas fa-user"></i>&thinsp;&thinsp;Hello '.$_SESSION['name'].'
                     </a>
                  </li>

                  <li class="nav-item">
                     <a class="nav-link" href="index.php"><i class="fas fa-sign-out-alt"></i>&ensp;Logout</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="cart.php?id_user='.$_SESSION['id_user'].'"><i class="fas fa-shopping-cart"></i>&thinsp;&thinsp;Cart</a>
                  </li>
